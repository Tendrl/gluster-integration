...
payload = {
    ...
    "run": "tendrl.gluster.objects.Volume.flows.ExpandVolume",
    "parameters": {
        "Volume.volname": 'Vol3',
        "Volume.vol_id": "ad8ca449-61ad-43d4-9e48-17acf4c7286e",
        "Volume.bricks": [
            [
                {"<hostname>":"/glusterfs/brick34/b34"},
                {"<hostname>":"/glusterfs/brick35/b35"},
                {"<hostname>":"/glusterfs/brick39/b39"},
            ]
        ],
        "Volume.force": True,
    },
...
def run():
    client = etcd.Client(host="12.23.34.45", port=2379)
